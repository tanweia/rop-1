...
public class DefaultRopClient implements RopClient {
    ...
    public DefaultRopClient(String serverUrl, String appKey, String appSecret, String accessToken) {
    	this.serverUrl = serverUrl;
        this.appKey = appKey;
        this.appSecret = appSecret;
	...
	public RopClient setAccessTokenParamName(String paramName) {
        SystemParameterNames.setAccessToken(paramName);
        return this;
    }
    ...
    private class DefaultClientRequest implements ClientRequest {
        ...
        private DefaultClientRequest(RopClient ropClient) {
            ...
            paramMap.put(SystemParameterNames.getAccessToken(), accessToken);
            if (sessionId != null) {
        ...
        private Map<String, String> getRequestForm(RopRequest ropRequest, String methodName, String version) {
            ...
            form.put(SystemParameterNames.getAccessToken(), accessToken);
